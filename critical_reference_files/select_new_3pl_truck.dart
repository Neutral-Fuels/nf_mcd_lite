...
class Select3PLTruckNew extends StatefulWidget {
  @override
  _Select3PLTruckNewState createState() => _Select3PLTruckNewState();
}

class _Select3PLTruckNewState extends State<Select3PLTruckNew> {
  Logger log = getLogger("_Select3PLTruckNewState");
  ...
  _getTruckList(String token, String clientId) async {
    ...
    log.i(
        "$functionName | getting new truck list for 3rd party | client id: $clientId");

    List trucks = await _listProvider.get3plTruckList(token, clientId);
    if (trucks != null) {
      log.d(
          "$functionName | successfully recieved new truck list for 3rd party");
      setState(() {
        _trucks = trucks;
  ...
  onItemChanged(String value) {
    ...
    log.d("$functionName | when searching for new 3rd party truck");
  ...
  Widget build(BuildContext context) {
    ...
    log.v(
        "$functionName | widget build for select new truck 3rd party license");
